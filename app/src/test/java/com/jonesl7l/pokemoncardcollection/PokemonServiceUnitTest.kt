...
class PokemonServiceUnitTest {
    ...
    fun dataDownloadedIsSuccess() {
        runBlocking {
            val result = AppModule.getPokemonCardService(AppModule.getRetrofitBuilder())
                .getPokemonCards("(id:${PokemonCardCollection.VESPIQUEN_XY7}%20or%20id:${PokemonCardCollection.ALAKAZAM_PL2}%20or%20id:${PokemonCardCollection.CUBONE_DP6}%20or%20id:${PokemonCardCollection.HARIYAMA_EX8})")
    ...
    fun cuboneDataIsCorrect() {
        runBlocking {
            val result = AppModule.getPokemonCardService(AppModule.getRetrofitBuilder())
                .getPokemonCards("id:${PokemonCardCollection.CUBONE_DP6}")
    ...
    fun alakazamDataIsCorrect() {
        runBlocking {
            val result = AppModule.getPokemonCardService(AppModule.getRetrofitBuilder())
                .getPokemonCards("id:${PokemonCardCollection.ALAKAZAM_PL2}")
    ...
    fun hariyamaDataIsCorrect() {
        runBlocking {
            val result = AppModule.getPokemonCardService(AppModule.getRetrofitBuilder())
                .getPokemonCards("id:${PokemonCardCollection.HARIYAMA_EX8}")
    ...
    fun vespiquenDataIsCorrect() {
        runBlocking {
            val result = AppModule.getPokemonCardService(AppModule.getRetrofitBuilder())
                .getPokemonCards("id:${PokemonCardCollection.VESPIQUEN_XY7}")
    ...
    companion object {
        ...
        private val cubone: Pokemon = Pokemon(
            PokemonCardCollection.CUBONE_DP6, "Cubone", "60", listOf(
                ...
                PokeAttack(
                    "Bonemerang",
                    listOf(FIGHTING_TYPE, COLORLESS_TYPE),
        ...
        private val alakazam = Pokemon(
            PokemonCardCollection.ALAKAZAM_PL2, "Alakazam E4 LV.X", "100", listOf(
                PokeAttack(
                    "Mind Shock",
                    listOf(PSYCHIC_TYPE, PSYCHIC_TYPE, COLORLESS_TYPE),
        ...
        private val vespiquen = Pokemon(
            PokemonCardCollection.VESPIQUEN_XY7, "Vespiquen", "90", listOf(
                PokeAttack(
                    ...
                    listOf(COLORLESS_TYPE),
                    "You may draw cards until you have 6 cards in your hand.",
                    "10"
                ),
                PokeAttack(
                    "Bee Revenge",
                    listOf(COLORLESS_TYPE, COLORLESS_TYPE),
